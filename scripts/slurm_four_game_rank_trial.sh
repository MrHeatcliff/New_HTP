#!/usr/bin/env bash
#SBATCH --job-name=rank32-four-games
...
#SBATCH --output=/home/vn-user0101/Dat/HTS-Dreamer/slurm_logs/rank32-four-%j.out
#SBATCH --error=/home/vn-user0101/Dat/HTS-Dreamer/slurm_logs/rank32-four-%j.err
set -euo pipefail
...
"$PYTHON" -m corewm_eval.four_game_representation --help
"$PYTHON" -m pytest tests/test_prefix_rank_floor.py tests/test_prefix_persistence.py \
  tests/test_phase3h_semantics.py tests/test_pdyn_episode_mask.py tests/test_coarse_reconstruction_target.py \
  tests/test_h200_suite.py -q
