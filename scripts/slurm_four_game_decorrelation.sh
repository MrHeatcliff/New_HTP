#!/usr/bin/env bash
#SBATCH --job-name=decorrel-four-games
...
#SBATCH --output=/home/vn-user0101/Dat/HTS-Dreamer/slurm_logs/decorrel-four-%j.out
#SBATCH --error=/home/vn-user0101/Dat/HTS-Dreamer/slurm_logs/decorrel-four-%j.err
set -euo pipefail
...
export HTP_FOUR_GAME_FACTOR=decorrelation
