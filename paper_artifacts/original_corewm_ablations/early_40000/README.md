...
Đối chứng trực tiếp: **`warmup_60000`** ([thư mục](../warmup_60000/)). Đối chứng bổ sung ngoài các dòng gốc trong Excel.
...
| Trường | Đối chứng `warmup_60000` | Ablation `early_40000` |
|---|---|---|
| `agent.htp.ablation_stop_actions` | `0` | `40000` |
| `agent.htp.ablation_warmup_actions` | `60000` | `0` |

<details><summary>Overrides đăng ký cho cấu hình này</summary>

```json
{
  "agent.htp.ablation_stop_actions": 40000,
