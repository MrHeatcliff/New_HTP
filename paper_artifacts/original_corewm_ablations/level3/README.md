...
| Trường | Đối chứng `full` | Ablation `level3` |
|---|---|---|
| `agent.htp.pdyn.dims` | `[128, 256, 512, 1024, 2048]` | `[128, 512, 2048]` |
| `agent.htp.pdyn.strides` | `[16, 8, 4, 2, 1]` | `[16, 4, 1]` |
| `agent.htp.proj.dims` | `[128, 256, 512, 1024, 2048]` | `[128, 512, 2048]` |
