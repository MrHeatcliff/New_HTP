...
Đối chứng trực tiếp: **`full`** ([thư mục](../full/)). Có trong Excel: `htp_reverse_strides`.
...
| Trường | Đối chứng `full` | Ablation `reverse` |
|---|---|---|
| `agent.htp.pdyn.enforce_coarse_to_fine` | `true` | `false` |
| `agent.htp.pdyn.strides` | `[16, 8, 4, 2, 1]` | `[1, 2, 4, 8, 16]` |
