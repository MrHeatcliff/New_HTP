...
Đối chứng trực tiếp: **`full`** ([thư mục](../full/)). Mốc warmup có trong Excel; áp dụng cho full.
...
| Trường | Đối chứng `full` | Ablation `warmup_40000` |
|---|---|---|
| `agent.htp.ablation_warmup_actions` | `0` | `40000` |

<details><summary>Overrides đăng ký cho cấu hình này</summary>

```json
{
  "agent.htp.ablation_warmup_actions": 40000,
