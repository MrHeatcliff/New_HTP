...
Actor, critic, reward và continuation đọc h thay vì projected z. Auxiliary heads vẫn dùng projection; raw_readout_full và raw_readout_flat tách đóng góp của auxiliary khi readout không tiêu thụ z.
...
| Trường | Đối chứng `flat` | Ablation `raw_readout_flat` |
|---|---|---|
| `agent.htp.ablation_raw_readout` | `false` | `true` |

<details><summary>Overrides đăng ký cho cấu hình này</summary>

```json
{
  "agent.htp.ablation_raw_readout": true,
