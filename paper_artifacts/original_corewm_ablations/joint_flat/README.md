...
Cho gradient của auxiliary loss đi vào encoder/RSSM thay vì stop-gradient h trước nhánh auxiliary. Các hệ số reconstruction/prediction xác định những nhánh đang bật.
...
| Trường | Đối chứng `flat` | Ablation `joint_flat` |
|---|---|---|
