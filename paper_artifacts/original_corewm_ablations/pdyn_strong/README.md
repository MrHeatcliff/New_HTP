...
Đổi riêng hệ số reconstruction hoặc prediction thành 0.1 hoặc 10; hệ số còn lại giữ nguyên. Hệ số nhân trực tiếp vào auxiliary loss trong tổng loss.
...
| Trường | Đối chứng `full` | Ablation `pdyn_strong` |
|---|---|---|
| `agent.loss_scales.htp_pdyn` | `1.0` | `10.0` |
...
```json
{
  ...
  "agent.loss_scales.htp_pdyn": 10.0,
