...
Đối chứng trực tiếp: **`warmup_80000`** ([thư mục](../warmup_80000/)). Đối chứng bổ sung ngoài các dòng gốc trong Excel.
...
| Trường | Đối chứng `warmup_80000` | Ablation `early_20000` |
|---|---|---|
| `agent.htp.ablation_stop_actions` | `0` | `20000` |
| `agent.htp.ablation_warmup_actions` | `80000` | `0` |

<details><summary>Overrides đăng ký cho cấu hình này</summary>

```json
{
  "agent.htp.ablation_stop_actions": 20000,
