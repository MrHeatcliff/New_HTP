...
Thay chiều rộng shared trunk hoặc tổng chiều rộng projected code. Đây là đối chứng kiến trúc có thay capacity và có thể thay compute, không phải so sánh parameter-matched.
...
| Trường | Đối chứng `full` | Ablation `compact_code` |
|---|---|---|
| `agent.htp.pdyn.dims` | `[128, 256, 512, 1024, 2048]` | `[32, 64, 128, 256, 512]` |
| `agent.htp.proj.dims` | `[128, 256, 512, 1024, 2048]` | `[32, 64, 128, 256, 512]` |
