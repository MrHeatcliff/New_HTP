...
Đối chứng trực tiếp: **`slim_zero`** ([thư mục](../slim_zero/)). Đối chứng bổ sung ngoài các dòng gốc trong Excel.
...
| Trường | Đối chứng `slim_zero` | Ablation `slim_variance_only` |
|---|---|---|
| `agent.htp.use_vicreg` | `false` | `true` |
