...
Thay số level và bộ cumulative prefix/stride, giữ full code width 2048. Số head và số tham số auxiliary thay đổi theo level.

Đối chứng trực tiếp: **`all16`** ([thư mục](../all16/)). Đối chứng bổ sung ngoài các dòng gốc trong Excel.
...
| Trường | Đối chứng `all16` | Ablation `level1_long` |
|---|---|---|
| `agent.htp.pdyn.dims` | `[128, 256, 512, 1024, 2048]` | `[2048]` |
| `agent.htp.pdyn.enforce_coarse_to_fine` | `false` | `true` |
| `agent.htp.pdyn.strides` | `[16, 16, 16, 16, 16]` | `[16]` |
| `agent.htp.proj.dims` | `[128, 256, 512, 1024, 2048]` | `[2048]` |
