...
Đối chứng trực tiếp: **`slim_zero`** ([thư mục](../slim_zero/)). Có trong Excel: `htp_slim_postHoc`.
...
| Trường | Đối chứng `slim_zero` | Ablation `slim_posthoc` |
|---|---|---|
| `agent.htp.grad_to_backbone` | `true` | `false` |
| `agent.loss_scales.htp_pdyn` | `0.0` | `1.0` |
